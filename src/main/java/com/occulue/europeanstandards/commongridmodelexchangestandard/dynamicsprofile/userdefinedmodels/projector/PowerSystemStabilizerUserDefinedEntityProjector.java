...
public class PowerSystemStabilizerUserDefinedEntityProjector {
  ...
  // core constructor
  public PowerSystemStabilizerUserDefinedEntityProjector(
   ...
   */
  public PowerSystemStabilizerUserDefined assignProprietary(
   ...
   * FindPowerSystemStabilizerUserDefinedQuery
   *
  ...
  public PowerSystemStabilizerUserDefined find(UUID id) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "Failed to find a PowerSystemStabilizerUserDefined - {0}",
          exc.getMessage());
    }
    return null;
  }
   ...
   */
  @SuppressWarnings("unused")
  public List<PowerSystemStabilizerUserDefined> findAll(
      FindAllPowerSystemStabilizerUserDefinedQuery query) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "Failed to find all PowerSystemStabilizerUserDefined - {0}",
          exc.getMessage());
    }
    return null;
  }
  ...
  // attributes
  // --------------------------------------------------
  @Autowired protected final PowerSystemStabilizerUserDefinedRepository repository;
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PowerSystemStabilizerUserDefinedEntityProjector.class.getName());
}
