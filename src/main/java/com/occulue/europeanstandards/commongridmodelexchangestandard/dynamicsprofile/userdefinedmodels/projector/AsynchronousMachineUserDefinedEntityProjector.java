 ...
 *
 * <p>Commands are handled by AsynchronousMachineUserDefinedAggregate
 *
...
public class AsynchronousMachineUserDefinedEntityProjector {
  ...
  // core constructor
  public AsynchronousMachineUserDefinedEntityProjector(
      AsynchronousMachineUserDefinedRepository repository) {
  ...
  /**
   * Method to retrieve the AsynchronousMachineUserDefined via an
   * FindAsynchronousMachineUserDefinedQuery
   *
  ...
  public AsynchronousMachineUserDefined find(UUID id) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING, "Failed to find a AsynchronousMachineUserDefined - {0}", exc.getMessage());
    }
    return null;
  }
   ...
   */
  @SuppressWarnings("unused")
  public List<AsynchronousMachineUserDefined> findAll(
      FindAllAsynchronousMachineUserDefinedQuery query) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING,
          "Failed to find all AsynchronousMachineUserDefined - {0}",
          exc.getMessage());
    }
    return null;
  }
  ...
  // attributes
  // --------------------------------------------------
  @Autowired protected final AsynchronousMachineUserDefinedRepository repository;
  ...
  private static final Logger LOGGER =
      Logger.getLogger(AsynchronousMachineUserDefinedEntityProjector.class.getName());
}
