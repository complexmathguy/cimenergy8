...
public class ExcIEEEDC2AEntityProjector {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignEfd1(UUID parentId, PU assignment) {
    LOGGER.info("assigning Efd1 as " + assignment.toString());

    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignEfd1(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignEfd2(UUID parentId, PU assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignEfd2(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignExclim(UUID parentId, PU assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignExclim(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignKa(UUID parentId, PU assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignKa(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignKe(UUID parentId, PU assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignKe(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignKf(UUID parentId, PU assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignKf(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignSeefd1(UUID parentId, Simple_Float assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignSeefd1(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignSeefd2(UUID parentId, Simple_Float assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignSeefd2(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignTa(UUID parentId, Seconds assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignTa(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignTb(UUID parentId, Seconds assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignTb(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignTc(UUID parentId, Seconds assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignTc(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignTe(UUID parentId, Seconds assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignTe(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignTf(UUID parentId, Seconds assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignTf(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignUelin(UUID parentId, BooleanProxy assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignUelin(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignVrmax(UUID parentId, PU assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignVrmax(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A assignVrmin(UUID parentId, PU assignment) {
   ...
   * @return	ExcIEEEDC2A
   */
  public ExcIEEEDC2A unAssignVrmin(UUID parentId) {
    ExcIEEEDC2A parentEntity = repository.findById(parentId).get();
  ...
  // attributes
  // --------------------------------------------------
  @Autowired protected final ExcIEEEDC2ARepository repository;

  @Autowired
  @Qualifier(value = "pU-entity-projector")
  com.occulue.europeanstandards.commongridmodelexchangestandard.domainprofile.PUEntityProjector
      PUProjector;
  ...
  com.occulue.europeanstandards.commongridmodelexchangestandard.domainprofile.SecondsEntityProjector
      SecondsProjector;
