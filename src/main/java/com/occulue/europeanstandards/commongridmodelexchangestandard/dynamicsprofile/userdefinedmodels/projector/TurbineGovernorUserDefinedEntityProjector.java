...
public class TurbineGovernorUserDefinedEntityProjector {
  ...
  // core constructor
  public TurbineGovernorUserDefinedEntityProjector(
      TurbineGovernorUserDefinedRepository repository) {
  ...
  public TurbineGovernorUserDefined find(UUID id) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING, "Failed to find a TurbineGovernorUserDefined - {0}", exc.getMessage());
    }
    return null;
  }
  ...
  public List<TurbineGovernorUserDefined> findAll(FindAllTurbineGovernorUserDefinedQuery query) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING, "Failed to find all TurbineGovernorUserDefined - {0}", exc.getMessage());
    }
    return null;
  }
  ...
  // attributes
  // --------------------------------------------------
  @Autowired protected final TurbineGovernorUserDefinedRepository repository;
  ...
  private static final Logger LOGGER =
      Logger.getLogger(TurbineGovernorUserDefinedEntityProjector.class.getName());
}
