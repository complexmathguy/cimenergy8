 ...
 *
 * <p>Commands are handled by DateTimeAggregate
 *
...
public class DateTimeEntityProjector {
  ...
  // attributes
  // --------------------------------------------------
  @Autowired protected final DateTimeRepository repository;
  ...
  @Autowired
  @Qualifier(value = "basicIntervalSchedule-entity-projector")
  com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.core
          .BasicIntervalScheduleEntityProjector
      BasicIntervalScheduleProjector;
